        ...
        <p className="flex justify-between items-center">
          ...
          {inCart ? (
            ...
            <button
              ...
              className={`inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800    disabled:bg-red-950 ${product.in_stock ? "" : "cursor-not-allowed"}`}
            >
              { product.in_stock ? "Add To Cart" : "Out Of Stock" } <i className={`ml-1 bi ${ product.in_stock ? "bi-plus-lg": ""}`}></i>
            </button>
          )}
        </p>
      </div>
